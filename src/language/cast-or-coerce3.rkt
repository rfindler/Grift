...
(define-type CoC3-Expr
  (Rec E (U
	  ...
	  ;;(Cast E (Twosome Grift-Type Grift-Type Blame-Label))
          ...
          (LabeledType-GRef-Of E)
          (LabeledType-GVect-Of E)
          (LabeledType-MRef-Huh E)
          (LabeledType-MRef-Of E)
          (LabeledType-MVect-Huh E)
          (LabeledType-MVect-Of E)
          (LabeledType-Tuple-Huh E)
          (LabeledType-Tuple-num E)
          (LabeledType-Tuple-item E E)
