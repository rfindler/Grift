...
(define-syntax-rule (labeled-type-int?$ t) (LabeledType-Int-Huh t))
(define-syntax-rule (labeled-type-bool?$ t) (LabeledType-Bool-Huh t))
(define-syntax-rule (labeled-type-float?$ t) (LabeledType-Float-Huh t))
(define-syntax-rule (labeled-type-unit?$ t) (LabeledType-Unit-Huh t))
(define-syntax-rule (labeled-type-char?$ t) (LabeledType-Character-Huh t))
(define-syntax-rule (labeled-type-tup?$ t) (LabeledType-Tuple-Huh t))
(define-syntax-rule (labeled-type-tup-arity$ t) (LabeledType-Tuple-num t))
(define-syntax-rule (labeled-type-fn?$ t) (LabeledType-Fn-Huh t))
(define-syntax-rule (labeled-type-fn-arity$ t) (LabeledType-Fn-arity t))
(define-syntax-rule (labeled-type-pbox?$ t) (LabeledType-GRef-Huh t))
(define-syntax-rule (labeled-type-pbox-of$ t) (LabeledType-GRef-Of t))
(define-syntax-rule (labeled-type-pvec?$ t) (LabeledType-GVect-Huh t))
(define-syntax-rule (labeled-type-pvec-of$ t) (LabeledType-GVect-Of t))
(define-syntax-rule (labeled-type-mbox?$ t) (LabeledType-MRef-Huh t))
(define-syntax-rule (labeled-type-mbox-of$ t) (LabeledType-MRef-Of t))
(define-syntax-rule (labeled-type-mvec?$ t) (LabeledType-MVect-Huh t))
(define-syntax-rule (labeled-type-mvec-of$ t) (LabeledType-MVect-Of t))
(define-syntax-rule (labeled-type-label$ t) (LabeledType-BlameLabel t))
