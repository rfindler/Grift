...
(define-forms
  ...
  (LabeledType-Fn-arity expression)
  (Type-Fn-arg expression index)
  (LabeledType-Fn-arg expression index)
  (Type-Fn-return expression)
  (LabeledType-Fn-return expression)
  (Type-Fn-Huh type)
  (LabeledType-Fn-Huh type)
  (Type-GVect-Huh type)
  (LabeledType-GVect-Huh type)
  (Type-GRef-Huh type)
  (LabeledType-GRef-Huh type)
  (Type-GRef-Of expression)
  (LabeledType-GRef-Of expression)
  (Type-GVect-Of expression)
  (LabeledType-GVect-Of expression)
  (Type-MRef-Huh expression)
  (LabeledType-MRef-Huh expression)
  (Type-MRef-Of expression)
  (LabeledType-MRef-Of expression)
  (Type-MVect-Huh expression)
  (LabeledType-MVect-Huh expression)
  (Type-MVect-Of expression)
  (LabeledType-MVect-Of expression)
  (Type-Tuple-Huh type)
  (LabeledType-Tuple-Huh type)
  (Type-Tuple-num type)
  (LabeledType-Tuple-num type)
  (Type-Tuple-item type index)
  (LabeledType-Tuple-item type index)
